...
public class Theme3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnArabe = (Button)findViewById (R.id.btnarticle3Arabe);
        btnFrancais = (Button)findViewById (R.id.btnarticle3Francais);
        ...
        btnFrancais.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View view) {
                ...
                bundle.putString ("theme", "theme3");
                bundle.putString ("article", "silsiltou_f.pdf");
        ...
        btnArabe.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View view) {
                ...
                Bundle bundle = new Bundle ();
                bundle.putString ("theme", "theme3");
                bundle.putString ("article", "silsitou_a.pdf");
