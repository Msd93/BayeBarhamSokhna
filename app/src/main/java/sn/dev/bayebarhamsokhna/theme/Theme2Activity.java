...
public class Theme2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnArabe = (Button)findViewById (R.id.btnarticle2Arabe);
        btnFrancais = (Button)findViewById (R.id.btnarticle2Francais);
        ...
        btnFrancais.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View view) {
                ...
                bundle.putString ("article", "abismane_f.pdf");
        ...
        btnArabe.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View view) {
                ...
                Bundle bundle = new Bundle ();
                bundle.putString ("theme", "theme2");
                bundle.putString ("article", "abismane_a.pdf");
